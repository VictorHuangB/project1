 ...
 */
public class TiqianquSingleTestActivity extends SerialPortActivity implements View.OnClickListener {
    int testCount = 0;
    boolean isTesting;
    boolean testOk;
...
//                TiqianquSingleTestActivity.this.finish();
            }
        });
        b.show();
    }
...
//            toast("班级为空");
    ...
    private void showSameUserDialog(final UserInfo oldUserInfo, final UserInfo newUserInfo) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                IcSameUserDialog selectDialog = new IcSameUserDialog(TiqianquSingleTestActivity.this, oldUserInfo, newUserInfo);
    ...
    private void onDataReceived_IC(final byte[] buffer, final int size) {
        ...
        if (success) {
            if (isPinLoad) {//密码下载成功
                ...
                if (checkICInfo()) {
                    //是否有两个同样的学号
                    if (UserModel.checkSameUser(TiqianquSingleTestActivity.this, icCode)) {
                        //拿到本地相同code的信息
                        ArrayList<UserInfo> userInfos = UserModel.queryUserInfoByEntireCode(TiqianquSingleTestActivity.this, icCode);
                    ...
                    UserModel.addItemToDatabase(TiqianquSingleTestActivity.this, info);
                    showUserInfo(info);
                    toast("读卡成功");
//                    ((TextView)result_ic).setText("读卡成功");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tiqianqu_test_layout);
    ...
    public void onBackPressed() {
        ...
        if (finishNotAllow) {
            final AppDialog appDialog = new AppDialog(TiqianquSingleTestActivity.this, "取消", "确定", true);
...
//        result_cancel = findViewById(R.id.result_cancel);
        ...
        animate_view.setBackgroundResource(R.drawable.tiqianqu_anim);
...
//        connectCountDownTimer.start();
    ...
    class LocalLoadTask extends AsyncTask<String, Void, ArrayList<UserInfo>> {
        ...
        protected ArrayList<UserInfo> doInBackground(String... params) {
            ...
            if (search != null) {
                userInfos = UserModel.queryUserInfoByCode(TiqianquSingleTestActivity.this, search);
            }
            //默认按学号排序
...
//            device_status.setText("测试完毕");
    ...
    void handleResultSave() {
        ...
        //保存最好的成绩
        if (userInfo != null) {
            UserModel.updateUserInfoInTiqianqu(TiqianquSingleTestActivity.this, userInfo, String.valueOf(max));
...
//        ((TextView)result_ic).setText("读卡");
    ...
    void handleSearchResult() {
        ...
        dataImportDialog = new DataImportDialog(TiqianquSingleTestActivity.this, "正在查询...");
        dataImportDialog.setCancelable(false);
